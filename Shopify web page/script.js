...
function renderCategories(data) {
    ...
    data.categories.forEach(category => {
        ...
        category.category_products.forEach(product => {
            ...
            cardBody.className = 'card-body product-details';
            ...
            productPrice.className = 'card-text text-success product-price ';
            productPrice.innerText = `₹${product.price}`;
            cardBody.appendChild(productPrice);

            const productCompareAtPrice = document.createElement('p');
            productCompareAtPrice.className = 'card-text text-danger product-compare-at-price';
            productCompareAtPrice.innerText = `₹${product.compare_at_price}`;
            cardBody.appendChild(productCompareAtPrice);

            if (product.badge_text) {
                const productBadge = document.createElement('span');
                productBadge.className = 'badge badge-warning product-badge';
                productBadge.innerText = product.badge_text;
                cardBody.appendChild(productBadge);
            }
